...
const seedProducts = () => db.Promise.map([{
  ...
  category: 'heart'
	...
	{name: "Dreamless Sleep Potion", description: "A potion that places the taker in a sleep that is dreamless.", image: "http://aqwwiki.wdfiles.com/local--files/use-items/PotionBlack.png", inventoryAmount: 50, price: 420, category: 'mind'},
